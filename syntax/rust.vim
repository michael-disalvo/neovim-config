...
hi def link rustBoolean       Number
...
hi def link rustKeyword       Macro
hi def link rustDynKeyword    Macro
hi def link rustTypedef       Macro " More precise is Typedef, but it doesn't feel right for Rust
hi def link rustStructure     Macro  " More precise is Structure
hi def link rustUnion         rustStructure
hi def link rustExistential   Macro
hi def link rustPubScopeDelim Delimiter
hi def link rustPubScopeCrate Macro
hi def link rustSuper         Macro
hi def link rustUnsafeKeyword Exception
hi def link rustReservedKeyword Error
hi def link rustRepeat        Conditional
hi def link rustConditional   Conditional
hi def link rustIdentifier    Function " Michael DiSalvo: this is the struct name! 
hi def link rustCapsIdent     rustIdentifier
hi def link rustModPath       Function " Michael DiSalvo: this is the last thing in a module path 
...
hi def link rustLabel         Macro
hi def link rustExternCrate   Macro 
hi def link rustObsoleteExternMod Error
hi def link rustQuestionMark  Special
hi def link rustAsync         Macro
hi def link rustAwait         Macro
hi def link rustAsmDirSpec    Macro
hi def link rustAsmSym        Macro
hi def link rustAsmOptions    Macro
